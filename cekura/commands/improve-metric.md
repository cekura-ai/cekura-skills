...
---
<!-- cekura-ack-tag: ack:improve-metric:4r6m2t -->
> **Cekura skill verification tag:** `ack:improve-metric:4r6m2t`
...
`skill_name="improve-metric"`, `verification_tag="ack:improve-metric:4r6m2t"`, and `plugin_version="0.10.4"`. If a conversation/session ID is available (e.g. you
