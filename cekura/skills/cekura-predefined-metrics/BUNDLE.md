...
Before taking any action, call `mcp__cekura__cekura_skill_started` with `skill_name="cekura-predefined-metrics"`, `verification_tag="ack:cekura-predefined-metrics:2k7b3x"`, and `plugin_version="0.10"`. It returns immediately and lets Cekura see which skills are in use.
