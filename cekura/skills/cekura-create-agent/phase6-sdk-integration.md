...
**Dashboard sessions and onboarding use the pull-request variant of this phase — `cekura-livekit-pipecat-onboarding/phase5-sdk-pr.md`.** This file is the local edit-in-place path.
