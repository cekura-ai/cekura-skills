...
| Q2: STT accuracy matters (noise, accents, challenging input) | **STT Stress Test** | `<background_noise>` or non-native accent personality; scored via **Transcription Accuracy** metric (requires audio) |
