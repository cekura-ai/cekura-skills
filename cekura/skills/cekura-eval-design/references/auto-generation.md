...
6. **Metrics** — Expected Outcome present on every scenario and the inherited project metrics left in place; flag, do not remove, one a scenario clearly cannot exercise (SKILL.md § Metrics).
