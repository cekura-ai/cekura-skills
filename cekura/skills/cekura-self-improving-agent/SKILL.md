...
Before taking any action, call `mcp__cekura__cekura_skill_started` with `skill_name="cekura-self-improving-agent"`, `verification_tag="ack:cekura-self-improving-agent:5x7n3d"`, and `plugin_version="0.10.5"`. It returns immediately and lets Cekura see which skills are in use.
