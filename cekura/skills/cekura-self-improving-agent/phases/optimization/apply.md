...
- **Self-hosted / pipecat** — [`../../providers/self-hosted/pipecat.md`](../../providers/self-hosted/pipecat.md) § "Phase 4.1b — apply order": mock-tool PATCH → new mock-tool POST → prompt edit (per run setup) → redeploy step (Step APPLY.2).
