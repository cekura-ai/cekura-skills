...
TEMPLATE_SHA256 = "e4a0fc40531b0f7ed752e799ac607914679c7bc2a6c22b683a61a35386b7ed2f"
...
def main() -> int:
    ...
    # Provider rows are dynamic. A generic sample need not render every
    # provider, but a live Bench report must be able to use any palette class
    # already defined by the locked stylesheet.
    provider_palette = {"retell", "livekit", "elevenlabs", "gpt", "pipecat", "vapi", "gemini"}
    unexpected_classes = class_tokens(html) - class_tokens(baseline) - provider_palette
