...
Ask: "What's your Cekura API key? You can find it at https://app.cekura.ai under Settings → API Keys."
...
### 4. Verify the .mcp.json files exist

Each Cekura plugin has a `.mcp.json` that auto-connects Claude Code to the MCP server. Check they exist:
