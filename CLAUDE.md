...
| `cekura-backfill-mock-manifests` | Backfill manual scenarios with expected mock tool calls (`generated_mock_tool_entries`) + matching agent mock data — companion to `cekura-eval-design` |
